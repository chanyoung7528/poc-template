/**
 * Widget: OnboardingGroupWidget
 * 
 * 역할: 온보딩 그룹 매칭 완료 화면
 * - OnboardingLayout + Content 조합
 * - 라우팅 로직 포함
 */
...
import styles from "./OnboardingGroupWidget.module.scss";

export function OnboardingGroupWidget() {
  ...
  const handleNext = () => {
    router.push("/join/onboarding/allergy" as Route);
  };
